...
void prisma(void)
{
	GLfloat vertice [8][3] = {
				...
				{0.5 ,5.5, 0.5},    //Coordenadas Vértice 4 V4
				{0.5 ,5.5, -0.5},    //Coordenadas Vértice 5 V5
				{-0.5 ,5.5, -0.5},    //Coordenadas Vértice 6 V6
				{-0.5 ,5.5, 0.5},    //Coordenadas Vértice 7 V7
				};
...
{
	GLfloat vertice[8][3] = {
		{ 2.5 ,-0.5, 0.5 },    //Coordenadas Vértice 0 V0
		{ -2.5 ,-0.5, 0.5 },    //Coordenadas Vértice 1 V1
		{ -2.5 ,-0.5, -0.5 },    //Coordenadas Vértice 2 V2
		{ 2.5 ,-0.5, -0.5 },    //Coordenadas Vértice 3 V3
		{ 2.5 ,0.5, 0.5 },    //Coordenadas Vértice 4 V4
		{ 2.5 ,0.5, -0.5 },    //Coordenadas Vértice 5 V5
		{ -2.5 ,0.5, -0.5 },    //Coordenadas Vértice 6 V6
		{ -2.5 ,0.5, 0.5 },    //Coordenadas Vértice 7 V7
	};
