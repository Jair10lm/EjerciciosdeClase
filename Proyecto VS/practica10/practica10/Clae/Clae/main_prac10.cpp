...
//************************************************************//
//***********Visual Studio 2017*******************//
//************** Alumno (s): Ramirez Hernandez Jose Angel Jair *********************************//
//*************		Lab. Computación Gráfica		Gpo: 6							******//
//*************		Practica 10: Animacion carrito							******//

//para mover al delorean se usa la barra espaciadora
...
void display ( void )   // Creamos la funcion donde se dibuja
{
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glTranslatef(0, 4, movKit);		//movkit es el movimiento
												//Coordenadas de la carroceria del carro			
	...
	glDisable(GL_LIGHTING);
		...
		pintaTexto(-12,10.5,-14,(void *)font,"Delorean");
		pintaTexto(-12, 9.0, -14.0, (void *)font, "Ramirez Hernandez Jose Angel Jair");
